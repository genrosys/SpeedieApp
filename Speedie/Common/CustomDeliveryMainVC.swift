...
import UIKit
import CarbonKit
class CustomDeliveryMainVC: UIViewController,CarbonTabSwipeNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        items = ["CUSTOM DELIVERY", "CUSTOM HISTORY"]
    ...
    func carbonTabSwipeNavigation(_ carbonTabSwipeNavigation: CarbonTabSwipeNavigation, viewControllerAt index: UInt) -> UIViewController {
        ...
        switch index {
        case 0:
            return self.storyboard!.instantiateViewController(withIdentifier: "CustomDeliveryFirstVC") as! CustomDeliveryFirstVC
        case 1:
            return self.storyboard!.instantiateViewController(withIdentifier: "CustomHistoryVC") as! CustomHistoryVC
